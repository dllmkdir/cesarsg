  ...
  return (
    <Layout>
      ...
      <div
        style={{
          backgroundImage:
            "linear-gradient(to bottom, #000000, #0d060a, #140c15, #17121e, #151827)",
        }}
      >
        <Scene wide></Scene>
      </div>
      ...
      >
        <Scene wide>
          <h3>
            Como podrás ver, el sonido es una herramienta impresionante cuando
            se trata de comunicar un mensaje, y para eso,{" "}
            <b>{username || "usuario"}</b>, puedo comentarte lo que a mi me
            gusta hacer:
          </h3>
        </Scene>
      </div>
          ...
          <div>
            <PopBlock bg="linear-gradient(135deg, #f6d365 0%, #fda085 100%)">
              ...
              <div className="description-info-box">
                Grabación y edición de Diálogos. Grabación y edición de
                Ambientes. Grabación y edición de Foleys.
              </div>
            </PopBlock>
            <PopBlock bg="linear-gradient(135deg, #f093fb 0%, #f5576c 100%)">
              ...
              <div className="description-info-box">
                ...
                películas, sabemos a qué suenan. Esto es gracias al diseño
                sonoro.
              </div>
            </PopBlock>
        ...
        <Scene wide position="center">
          <div>
            <h3>
              ...
              gratuita para su descarga, sigue bajando para encontrarlos.
